            ...
            <div class="pt-2">
                ...
                <div class="space-y-3">
                    @foreach($tierTags as $tag)
                        @php($tier = $product->priceTiers->firstWhere('customer_tag', $tag))
                        <div class="grid grid-cols-1 sm:grid-cols-3 gap-3 items-end">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    value="{{ old("price_tiers.$tag.price", $tier?->price) }}"
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    value="{{ old("price_tiers.$tag.min_quantity", $tier?->min_quantity) }}"
